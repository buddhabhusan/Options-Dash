...
# Dynamic local path
LOCAL_PATH = BASE_DIR / os.getenv('LOCAL_PATH', 'venv')  # Example: BASE_DIR / 'venv'

# the secret key used in production secret!
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-fdr&@mg1!*=9thk0_*1ixn0_9#a8y%pl)p-=0jr3zz3xef0mcn')
